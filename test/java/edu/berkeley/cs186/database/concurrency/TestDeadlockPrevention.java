...
public class TestDeadlockPrevention {
  ...
  public void testFourTransactionCycleDeadlock() throws InterruptedException {
      final LockManager lockMan = new LockManager();
      AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("A", 1, LockManager.LockType.EXCLUSIVE);
      ...
      AsyncDeadlockTesterThread thread22 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("B", 2, LockManager.LockType.EXCLUSIVE);
          }
      }, "Transaction 2 Second Thread");
      ...
      AsyncDeadlockTesterThread thread32 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("C", 3, LockManager.LockType.EXCLUSIVE);
          }
      }, "Transaction 3 Second Thread");
      ...
      AsyncDeadlockTesterThread thread42 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("D", 4, LockManager.LockType.EXCLUSIVE);
          }
      }, "Transaction 1 Second Thread");

      AsyncDeadlockTesterThread thread12 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
      ...
      try {
        ...
        fail("no deadlock exists but exception was thrown");
      }
      ...
      try {
          ...
          thread12.join(100);
          thread12.test();
          fail("no deadlock exception was thrown");
      } catch (DeadlockException d) {
  ...
  @Test
  @Category(StudentTestP3.class)
  public void noCyclesWithOnlySharedLocks() throws InterruptedException {
      final LockManager lockMan = new LockManager();
      AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
      ...
      AsyncDeadlockTesterThread thread4 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("C", 4, LockManager.LockType.SHARED);
          }
      }, "Transaction 4 Thread");

      AsyncDeadlockTesterThread thread42 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("D", 4, LockManager.LockType.SHARED);
          }
      }, "Transaction 1 Second Thread");
  ...
  @Test
  @Category(StudentTestP3.class)
  public void noCycleWithSoloExclusiveRequest() throws InterruptedException {
      final LockManager lockMan = new LockManager();
      AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
          public void run() {
              lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
