...
public class QueryPlanCostsTest {
  ...
  public void emptyTablesJoinCosts() throws DatabaseException, QueryPlanException{
      this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable1");
      this.database.createTable(TestUtils.createSchemaWithAllTypes(), "tempIntTable2");
      ...
      //SNLJ
      JoinOperator leftJoinRightSNLJ = new SNLJOperator(left, right, "int", "int", transaction);
      JoinOperator rightJoinLeftSNLJ = new SNLJOperator(right, left, "int", "int", transaction);

      assertEquals(0, leftJoinRightSNLJ.estimateIOCost());
      assertEquals(0, rightJoinLeftSNLJ.estimateIOCost());

      //PNLJ
      JoinOperator leftJoinRightPNLJ = new PNLJOperator(left, right, "int", "int", transaction);
      JoinOperator rightJoinLeftPNLJ = new PNLJOperator(right, left, "int", "int", transaction);

      assertEquals(0, leftJoinRightPNLJ.estimateIOCost());
      assertEquals(0, rightJoinLeftPNLJ.estimateIOCost());

      //BNLJ
      JoinOperator leftJoinRightBNLJ = new BNLJOperator(left, right, "int", "int", transaction);
      JoinOperator rightJoinLeftBNLJ = new BNLJOperator(right, left, "int", "int", transaction);

      assertEquals(0, leftJoinRightBNLJ.estimateIOCost());
      assertEquals(0, rightJoinLeftBNLJ.estimateIOCost());

      //GraceHash
      JoinOperator leftJoinRightGrace = new GraceHashOperator(left, right, "int", "int", transaction);
      JoinOperator rightJoinLeftGrace = new GraceHashOperator(right, left, "int", "int", transaction);

      assertEquals(0, leftJoinRightGrace.estimateIOCost());
      assertEquals(0, rightJoinLeftGrace.estimateIOCost());
